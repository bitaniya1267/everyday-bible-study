...
class BibleStudyHub extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Everyday Bible Study Journal'),
      ),
      body: Center(
          ...
          child: ListView(
            ...
            children: [
              ...
              _MenuCard(
                ...
                subtitle:
                    'What this says about God, Christ, and humans.',
              ...
              _MenuCard(
                ...
                subtitle:
                    'Questions, life application, memory verse, and prayer.',
              ...
              _MenuCard(
                ...
                subtitle:
                    'Track your chapter-by-chapter reading progress.',
...
class BibleCharacterStudyPage extends StatefulWidget {
  ...
  @override
  State<BibleCharacterStudyPage> createState() =>
      _BibleCharacterStudyPageState();
}

class _BibleCharacterStudyPageState
    extends State<BibleCharacterStudyPage> {
  ...
  Future<void> _load() async {
    ...
    for (final entry in fields.entries) {
      entry.value.text =
          prefs.getString('character_${entry.key}') ?? '';
    }
  ...
  Future<void> _save() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Character study saved.'),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Bible Character Study'),
            ...
            child: Column(
              children: [
                ...
                responsiveRow(
                  StudyField(
                    label: 'CHARACTER',
                    controller: fields['character']!,
                  ),
                  StudyField(
                    label: 'KNOWN FOR',
                    controller: fields['knownFor']!,
                  ),
                ),
                ...
                box(
                  ...
                  [
                    StudyField(
                      label: 'Book(s)',
                      controller: fields['books']!,
                    ),
                    const SizedBox(height: 10),
                    StudyField(
                      label: 'Chapter(s)',
                      controller: fields['chapters']!,
                    ),
                    const SizedBox(height: 10),
                    StudyField(
                      label:
                          'Tell their story in your own words',
                      controller: fields['story']!,
                      maxLines: 5,
                    ),
                  ],
                ),
                ...
                responsiveRow(
                  ...
                  box(
                    ...
                    [
                      StudyField(
                        label:
                            'Write verse(s) that stand out',
                        controller: fields['keyVerses']!,
                        maxLines: 6,
                      ),
                    ],
                  ),
                ...
                responsiveRow(
                  box(
                    ...
                    [
                      StudyField(
                        label:
                            'Struggles, mistakes, or hard moments?',
                        controller: fields['challenges']!,
                        maxLines: 5,
                      ),
                    ],
                  ),
...
class _ChapterStudyPageState
  ...
  Future<void> _load() async {
    ...
    for (final entry in fields.entries) {
      entry.value.text =
          prefs.getString('chapter_${entry.key}') ?? '';
    }
  }
  ...
  Future<void> _save() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Chapter study saved.'),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Chapter Study'),
      ),
      body: Center(
        child: ConstrainedBox(
          constraints: const BoxConstraints(
            ...
            child: Column(
              children: [
                ...
                responsiveRow(
                  StudyField(
                    label: 'Author',
                    controller: fields['author']!,
                  ),
                  StudyField(
                    label: 'Audience',
                    controller: fields['audience']!,
                  ),
                ),
...
class QuietTimeNotesPage extends StatefulWidget {
  ...
  @override
  State<QuietTimeNotesPage> createState() =>
      _QuietTimeNotesPageState();
}

class _QuietTimeNotesPageState
    extends State<QuietTimeNotesPage> {
  final fields = <String, TextEditingController>{
    'date': TextEditingController(),
    'passage': TextEditingController(),
  ...
  Future<void> _load() async {
    ...
    for (final entry in fields.entries) {
      entry.value.text =
          prefs.getString('quiet_${entry.key}') ?? '';
    }
  }
  ...
  Future<void> _save() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Quiet time notes saved.'),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Quiet Time Notes'),
      ),
      body: Center(
        child: ConstrainedBox(
          constraints: const BoxConstraints(
...
class ReflectionPage extends StatefulWidget {
  ...
  @override
  State<ReflectionPage> createState() =>
      _ReflectionPageState();
}

class _ReflectionPageState
    extends State<ReflectionPage> {
  final fields = <String, TextEditingController>{
    'date': TextEditingController(),
  ...
  Future<void> _load() async {
    ...
    for (final entry in fields.entries) {
      entry.value.text =
          prefs.getString('reflection_${entry.key}') ?? '';
    }
  }
              ...
              children: [
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          StudyField(
                            label: 'BOOK',
                            controller: fields['book']!,
                          ),
                          const SizedBox(height: 7),
                          StudyField(
                            label: 'CHAPTER',
                            controller: fields['chapter']!,
                          ),
                        ],
                      ),
                    ),
                ...
                responsiveRow(
                  Column(
                    children: [
                      StudyField(
                        label: 'WHAT QUESTIONS DO I HAVE?',
                        controller: fields['questions']!,
                        maxLines: 4,
                      ),
                      const SizedBox(height: 12),
                      StudyField(
                      ...
                      StudyField(
                        ...
                        controller: fields['furtherStudy']!,
                        maxLines: 4,
                      ),
                    ],
                  ),
...
// ==========================================================
// 5. NEW TESTAMENT READING TRACKER
// ==========================================================
...
class _NewTestamentTrackerPageState
  ...
  Future<void> _saveProgress() async {
    ...
    for (final entry in readChapters.entries) {
      data[entry.key] =
  ...
  Future<void> reset() async {
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text(
          'All New Testament chapter checkmarks will be removed.',
        ),
        actions: [
          TextButton(
            onPressed: () =>
